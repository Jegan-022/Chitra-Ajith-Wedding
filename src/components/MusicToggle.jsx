...
export default function MusicToggle() {
  ...
  return (
    ...
    >
      ...
      {playing && (
        <>
          <span className="absolute inset-0 rounded-full animate-ping opacity-30 bg-yellow-400"></span>
          <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-yellow-300 delay-500"></span>
        </>
      )}
